      ...
      <div class="ota-hero__body">
        ...
        <div class="ota-hero__buttons">
          <a href="#apply-form" class="ota-btn ota-btn--primary">
            申込フォームへ
            <img src="<?php echo yuumi_img('arrow-btn-white.svg'); ?>" alt="" width="17" height="17" aria-hidden="true">
          </a>
    ...
    <div class="ota-about__inner">
      ...
      <div class="ota-about__body">
        ...
        <div class="ota-about__text">
          <p>十和田市は青森県南部に位置し、約6万人が暮らすまちです。</p>
          <p>四季折々の自然に恵まれながら、市街地には商業施設や病院、学校など生活に必要な環境も整っています。</p>
          <p>世界的にも知られる十和田市現代美術館や、特別名勝・天然記念物の奥入瀬渓流など、多くの観光資源がある都会過ぎず、田舎過ぎない、ちょうどいいまちです。</p>
        </div>
        <div class="ota-about__stats">
          <div class="ota-about__stat">
            <span class="ota-about__stat-label">人口</span>
            <span class="ota-about__stat-value">約6万人</span>
          </div>
          <div class="ota-about__stat">
            <span class="ota-about__stat-label">面積</span>
            <span class="ota-about__stat-value">725.67km²</span>
          </div>
          <div class="ota-about__stat">
            <span class="ota-about__stat-label">アクセス</span>
            <span class="ota-about__stat-value">十和田駅から車で約20分</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="ota-recruit__inner">
      <div class="ota-recruit__item">
        ...
        <div class="ota-recruit__content">
          <p>2026年8月1日～2027年3月15日</p>
          <p>2泊3日の行程で十和田市に滞在できます。平日、休日など、ご希望の日時を事前に調整いたします</p>
        </div>
      </div>
      <div class="ota-recruit__item">
        <span class="ota-recruit__badge">定員</span>
        <div class="ota-recruit__content">
          <p><strong>期間中5名</strong></p>
        </div>
      </div>
      <div class="ota-recruit__item">
        <span class="ota-recruit__badge">お申し込金</span>
        <div class="ota-recruit__content">
      ...
      <div class="ota-recruit__item">
        ...
        <div class="ota-recruit__content">
          <p>❶ 現在、三大都市圏または地方都市等（過疎、山村、離島、半島などの地域に該当しない市町村）に住民票の登録と生活拠点がある方（該当するか不明の方は、事前にお問い合わせください）</p>
          <p>❷ 概ね20歳から40歳くらいまでの方</p>
          <p>❸ 心身ともに健康であり、誠実に活動を行うことができる方</p>
          <p>❹ 地方公務員法（昭和25年法律第261号）第16条に規定する欠格条項に該当しない方</p>
    ...
    <div class="ota-themes__grid">
      ...
      <div class="ota-theme-card">
        <div class="ota-theme-card__head">
          ...
          <h3 class="ota-theme-card__title">十和田湖地域での保育</h3>
        </div>
        <div class="ota-theme-card__img">
          <img src="<?php echo yuumi_img('otameshi/theme-02.png'); ?>" alt="十和田湖地域での保育">
        </div>
        <p class="ota-theme-card__desc">十和田湖地域での暮らしや、地域に根ざした保育の現場について知ることができます。</p>
      </div>
      <div class="ota-theme-card">
        <div class="ota-theme-card__head">
        ...
        <p class="ota-theme-card__desc">十和田湖地域での暮らしや、十和田市の産品である「十和田湖ひめます」に関わる仕事について知ることができます。</p>
      </div>
      <div class="ota-theme-card">
        <div class="ota-theme-card__head">
  ...
  <section class="ota-flow fade-in">
    ...
    <div class="ota-flow__steps">
      <div class="ota-flow__arrow ota-flow__arrow--start">
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="20" viewBox="0 0 13 20" fill="none"><path d="M0 10H13" stroke="#5EE4E4" stroke-width="20"/></svg>
      </div>
      ...
      <div class="ota-flow__arrow">
        <img src="<?php echo yuumi_img('otameshi/arrow-step-cyan.svg'); ?>" alt="" width="30" height="15" aria-hidden="true">
      </div>
      <div class="ota-flow__step">
      ...
      <div class="ota-flow__arrow ota-flow__arrow--end">
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="20" viewBox="0 0 13 20" fill="none"><path d="M0 10H13" stroke="#5EE4E4" stroke-width="20"/></svg>
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="46" viewBox="0 0 13 46" fill="none"><path d="M0 0L13 23L0 45.5V0Z" fill="#5EE4E4"/></svg>
      </div>
    </div>
  </section>
    ...
    <div class="ota-coordinator__card">
      ...
      <div class="ota-coordinator__content">
        <div class="ota-coordinator__photo">
          <img src="<?php echo yuumi_img('otameshi/coordinator.png'); ?>" alt="渡邊ゆうみ" loading="lazy">
        </div>
    ...
    <div class="ota-apply__inner">
      ...
      <div class="ota-apply__top">
        ...
        <div class="ota-apply__cta-card">
          ...
          <a href="<?php echo esc_url(home_url('/contact/')); ?>" class="ota-btn ota-btn--primary ota-btn--full">
            申し込みフォームへ進む
            <svg width="6" height="12" viewBox="0 0 6 12" fill="none"><path d="M1 1L5 6L1 11" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
          </a>
        </div>
      </div>
    ...
    <div class="ota-faq__inner">
      <div class="ota-faq__header">
        ...
        <a href="<?php echo esc_url(home_url('/faq/')); ?>" class="ota-faq__link">
          すべての質問を見る
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="13" r="13" fill="#37d4d4"/><path d="M11 9L15 13L11 17" stroke="white" stroke-width="1.5" stroke-linecap="round"/></svg>
        </a>
      </div>
        ...
        <div class="ota-faq-item is-open">
          ...
          <div class="ota-faq-item__answer" style="max-height:200px;">
            <div class="ota-faq-item__a-inner">
              ...
              <p class="ota-faq-item__a-text">サービスごとの詳しいQ&amp;Aは、よくある質問ページにまとめています。</p>
            </div>
          </div>
        </div>
